...
class TestControlPlaneApis(unittest.TestCase):
    @mock_ssm
    def test_get_profiles_handler(self) -> None:
    ...
    def test_get_profile(self) -> None:
        profile = {"Profile": "TestProfile", "Key": "Value"}

        ssm = boto3.client("ssm")
        ssm.put_parameter(Name=f"{get_list_apis.PROFILES_SSM_PARAMETER_PREFIX}/default/test", Value=json.dumps(profile))

        event = {"ProfileName": "test"}
    ...
    def test_get_configuration(self) -> None:
        configuration = {"Configuration": "TestConfiguration", "Key": "Value"}
    ...
    @mock_ssm
    def test_get_functions_handler(self) -> None:
        event = {"Namespace": "test"}
    ...
    def test_get_function(self) -> None:
        function = {"Function": "TestFunction", "Key": "Value"}

        ssm = boto3.client("ssm")
        ssm.put_parameter(
            Name=f"{get_list_apis.FUNCTIONS_SSM_PARAMETER_PREFIX}/default/test", Value=json.dumps(function)
        )
