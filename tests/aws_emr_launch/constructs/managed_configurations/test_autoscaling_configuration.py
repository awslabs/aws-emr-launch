...
default_config = {
        ...
        "Instances": {
            ...
            "InstanceGroups": [
                ...
                },
                {
                    "InstanceCount": 2,
                    "AutoScalingPolicy": {
                        "Constraints": {"MinCapacity": 2, "MaxCapacity": 5},
                        "Rules": [
                            {
                                "Action": {
                                ...
                                "Trigger": {
                                    "CloudWatchAlarmDefinition": {
                                        ...
                                        "Statistic": "AVERAGE",
                                        "Period": 300,
                                        "Dimensions": [{"Value": "${emr.clusterId}", "Key": "JobFlowId"}],
                                        "EvaluationPeriods": 3,
                                        "Unit": "PERCENT",
    ...
    "OverrideInterfaces": {
        "default": {
            "ClusterName": {"JsonPath": "Name", "Default": "test-cluster"},
            "ReleaseLabel": {"JsonPath": "ReleaseLabel", "Default": "emr-5.29.0"},
            "StepConcurrencyLevel": {"JsonPath": "StepConcurrencyLevel", "Default": 1},
            "MasterInstanceType": {"JsonPath": "Instances.InstanceGroups.0.InstanceType", "Default": "m5.2xlarge"},
            "MasterInstanceMarket": {"JsonPath": "Instances.InstanceGroups.0.Market", "Default": "ON_DEMAND"},
            "CoreInstanceCount": {"JsonPath": "Instances.InstanceGroups.1.InstanceCount", "Default": 2},
            "CoreInstanceType": {"JsonPath": "Instances.InstanceGroups.1.InstanceType", "Default": "m5.xlarge"},
            "CoreInstanceMarket": {"JsonPath": "Instances.InstanceGroups.1.Market", "Default": "ON_DEMAND"},
            "Subnet": {"JsonPath": "Instances.Ec2SubnetId", "Default": {"Ref": "testvpcPrivateSubnet1Subnet865FB50A"}},
            "TaskInstanceType": {"JsonPath": "Instances.InstanceGroups.2.InstanceType", "Default": "m5.xlarge"},
            "TaskInstanceMarket": {"JsonPath": "Instances.InstanceGroups.2.Market", "Default": "ON_DEMAND"},
            "TaskInitialInstanceCount": {"JsonPath": "Instances.InstanceGroups.2.InstanceCount", "Default": 2},
...
def test_default_configuration() -> None:
    cluster_config = autoscaling_configuration.AutoScalingClusterConfiguration(
        ...
        subnet=cast(ec2.Subnet, vpc.private_subnets[0]),
    )
