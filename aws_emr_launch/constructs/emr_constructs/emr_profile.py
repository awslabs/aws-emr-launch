...
class EMRProfile(BaseConstruct):
    ...
    def set_tls_certificate(self, certificate_location: str) -> "EMRProfile":
        ...
        self._tls_certificate_configuration = {
            "TLSCertificateConfiguration": {"CertificateProviderType": "PEM", "S3Object": certificate_location}
        }
        self._construct_security_configuration()
        return self
    ...
    def set_local_kdc(
        ...
        self._kerberos_configuration = {
            ...
            "ClusterDedicatedKdcConfiguration": {"TicketLifetimeInHours": ticket_lifetime_in_hours},
        }
        logger.warn("------------------------------------------------------------------------------")
    ...
    def add_emrfs_role_mapping_for_s3_prefixes(self, role: iam.Role, s3_prefixes: List[str]) -> "EMRProfile":
        ...
        if self._emrfs_configuration is None:
            self._emrfs_configuration = {"RoleMappings": []}

        self._emrfs_configuration["RoleMappings"].append(
            {"Role": role.role_arn, "IdentifierType": "Prefix", "Identifiers": s3_prefixes}
        )
        return self
    ...
    def add_emrfs_role_mapping_for_users(self, role: iam.Role, users: List[str]) -> "EMRProfile":
        ...
        self._emrfs_configuration["RoleMappings"].append(
            {"Role": role.role_arn, "IdentifierType": "User", "Identifiers": users}
        )
        return self
    ...
    def add_emrfs_role_mapping_for_groups(self, role: iam.Role, groups: List[str]) -> "EMRProfile":
        ...
        self._emrfs_configuration["RoleMappings"].append(
            {"Role": role.role_arn, "IdentifierType": "Group", "Identifiers": groups}
        )
        return self
    ...
    def get_profiles(
        ...
        profiles = {"EMRProfiles": [json.loads(p["Value"]) for p in result["Parameters"]]}
